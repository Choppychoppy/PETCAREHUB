...
async function seed() {
  ...
  try {
    ...
    // Profiles
    const profiles = [
      { userId: adminId, name: 'Trần Quốc Bảo', phone: '0901234567', address: '123 Nguyễn Huệ, Quận 1, TP.HCM', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200', gender: 'male', city: 'Hồ Chí Minh', bio: 'Quản trị viên hệ thống PetCareHub' },
