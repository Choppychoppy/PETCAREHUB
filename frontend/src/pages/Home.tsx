  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: 'Dịch vụ tuyệt vời! Nhân viên rất chuyên nghiệp và yêu thương động vật. Mèo nhà mình rất thích đến đây.',
      pet: 'Mèo Milo'
    },
    {
      name: 'Anh Minh Tuấn',
      ...
      rating: 5,
      comment: 'Đặt lịch online rất tiện lợi. Bác sĩ tư vấn kỹ lưỡng và giá cả hợp lý.',
    ...
    },
    {
      ...
      avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face',
      rating: 5,
      comment: 'Spa cho chó ở đây tuyệt vời lắm! Sau khi grooming, bé Luna trông xinh đẹp và thơm tho.',
      pet: 'Chó Poodle Luna'
    }
  ]
  ...
  return (
    <div className="min-h-screen overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-10">
        {/* Floating Icons */}
        <div className="absolute top-20 left-10 text-emerald-200/30 animate-bounce" style={{ animationDelay: '0s', animationDuration: '3s' }}>
          <Heart className="w-8 h-8" />
        </div>
        <div className="absolute top-32 right-20 text-blue-200/30 animate-bounce" style={{ animationDelay: '1s', animationDuration: '4s' }}>
          <Stethoscope className="w-10 h-10" />
        </div>
        <div className="absolute top-48 left-1/4 text-emerald-200/20 animate-pulse" style={{ animationDelay: '2s', animationDuration: '2s' }}>
          <Calendar className="w-6 h-6" />
        </div>
        <div className="absolute top-64 right-1/3 text-amber-200/30 animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '3.5s' }}>
          <Scissors className="w-9 h-9" />
        </div>
        <div className="absolute bottom-40 left-16 text-emerald-200/30 animate-pulse" style={{ animationDelay: '1.5s', animationDuration: '2.5s' }}>
          <Shield className="w-5 h-5" />
        </div>
        <div className="absolute bottom-56 right-16 text-blue-200/20 animate-bounce" style={{ animationDelay: '2.5s', animationDuration: '4s' }}>
          <Star className="w-7 h-7" />
        </div>
        <div className="absolute bottom-32 left-1/3 text-emerald-200/30 animate-pulse" style={{ animationDelay: '0.8s', animationDuration: '3s' }}>
          <PawPrint className="w-6 h-6" />
        </div>
        
        {/* Floating Particles */}
        <div className="absolute top-16 right-1/4 text-emerald-100/40 animate-ping" style={{ animationDelay: '2s', animationDuration: '4s' }}>
          <div className="w-2 h-2 bg-emerald-300 rounded-full"></div>
        </div>
        <div className="absolute bottom-20 left-1/5 text-blue-100/40 animate-ping" style={{ animationDelay: '0s', animationDuration: '3s' }}>
          <div className="w-3 h-3 bg-blue-300 rounded-full"></div>
        </div>
        <div className="absolute top-40 left-1/2 text-amber-100/40 animate-ping" style={{ animationDelay: '1s', animationDuration: '5s' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-gray-900">
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-8">
                ...
                <span className="block text-emerald-600 mt-2">với tình yêu</span>
              </h1>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Lịch hẹn được xác nhận</p>
                      <p className="text-sm text-gray-600">Dr. Sarah Johnson - 14:30</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute top-4 -right-4 bg-white/95 backdrop-blur-sm rounded-xl p-3 shadow-lg border border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Chứng nhận ISO</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <Card key={index} className="text-center p-6 bg-white shadow-lg rounded-2xl border border-gray-100">
          ...
          {servicesLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {(services.length > 0 ? services : fallbackServices).map((service, index) => (
                <Card key={index} className="group hover:shadow-xl transition-all duration-300 border border-gray-100 bg-white relative overflow-hidden">
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-1 mb-4">
                      ...
                      <span className="text-xs text-gray-500 ml-2">120 đánh giá</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                      <div>
                        <span className="text-2xl font-bold text-emerald-600">
                          {service.price ? (typeof service.price === 'number' ? formatVND(service.price) : service.price) : 'Liên hệ'}
                        </span>
                        {service.comparePrice && (
                          <span className="text-sm text-gray-500 line-through ml-2">
                            {typeof service.comparePrice === 'number' ? formatVND(service.comparePrice) : service.comparePrice}
                          </span>
                        )}
                      </div>
                      <Link to={`/services/${service.id || index}`}>
          ...
          <div className="flex items-center justify-between mb-16">
            <div>
              ...
              <p className="text-xl text-gray-600 max-w-2xl">
                Các sản phẩm chăm sóc thú cưng được tuyển chọn kỹ lưỡng từ những thương hiệu uy tín.
              </p>
            </div>
            <Link to="/products">
              <Button variant="outline" className="hidden md:flex border-emerald-500 text-emerald-600 hover:bg-emerald-50">
                Xem tất cả
                <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
            </Link>
          ...
          {productsLoading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {(products.length > 0 ? products : fallbackProducts).map((product, index) => (
                <Card key={product.id || index} className="group hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden bg-white">
                  <div className="relative">
                    <Link to={`/products/${product.id || index}`} className="block">
                      <img
                        src={product.images?.[0]?.imageUrl || product.image || PRODUCT_FALLBACK_IMG}
                        alt={product.name}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <div className="flex items-center gap-1">
                        {[1,2,3,4,5].map(i => (
                          <Star key={i} className={`w-4 h-4 ${i <= Math.floor(product.rating || 4.5) ? 'fill-amber-400 text-amber-400' : 'text-gray-300'}`} />
                        ))}
                      </div>
                    ...
                    <div className="pt-4 border-t border-gray-100">
                      ...
                      <div className="flex gap-2">
                        <Link to={`/products/${product.id || index}`} className="flex-1">
                          <Button size="sm" variant="outline" className="w-full border-emerald-500 text-emerald-600 hover:bg-emerald-50">
                            Xem chi tiết
                          </Button>
                        </Link>
                        <Button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-6 border border-gray-100 bg-white shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-center gap-1 mb-4">
                  {[1,2,3,4,5].map(i => (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Chủ nhân của {testimonial.pet}</p>
                  </div>
                </div>
              </Card>
            ))}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Liên hệ ngay hôm nay và trải nghiệm dịch vụ chăm sóc thú cưng 
              tốt nhất tại PetCare Hub.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/services">
                <Button size="lg" className="bg-emerald-500 text-white hover:bg-emerald-600 shadow-xl">
                  <Calendar className="w-5 h-5 mr-2" />
                  Đặt lịch ngay
                </Button>
              </Link>
