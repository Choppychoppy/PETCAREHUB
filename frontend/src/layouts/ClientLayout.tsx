...
export default function ClientLayout({ children }: ClientLayoutProps) {
  ...
  const { items: cartItems, totalItems, totalPrice, removeFromCart } = useCart()
  ...
  const handleNavigationClick = (e: React.MouseEvent, item: { href: string; protected: boolean; name: string }) => {
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden lg:block">
                <form onSubmit={handleSearch} className="relative">
                  ...
                  >
                    <svg className="w-4 h-4 text-gray-400 hover:text-[#2E86AB]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {cartMenuOpen && (
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                    <div className="p-4 border-b border-gray-100">
                      <h3 className="font-semibold text-gray-900">Giỏ hàng ({totalItems})</h3>
                    </div>
                      ...
                      <>
                          ...
                          {cartItems.slice(0, 3).map((item) => (
                            <div key={item.id} className="flex items-center gap-3 p-3 hover:bg-gray-50 border-b border-gray-50">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500">SL: {item.quantity} × {item.price.toLocaleString()}đ</p>
                              </div>
                              <button
                                onClick={(e) => {
                                  e.stopPropagation()
                        ...
                        <div className="p-4 border-t border-gray-100">
                          <div className="flex justify-between mb-3">
                            ...
                            <span className="font-semibold text-[#2E86AB]">{totalPrice.toLocaleString()}đ</span>
                          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-emerald-400 text-sm">Chăm sóc thú cưng tận tâm</p>
                </div>
              </div>
              <p className="text-gray-300 text-sm leading-relaxed">
                Nền tảng chăm sóc thú cưng hàng đầu Việt Nam, cung cấp dịch vụ chuyên nghiệp 
                và tận tâm cho những người bạn bốn chân.
              </p>
              <div>
                <h5 className="text-sm font-semibold text-white mb-3">Theo dõi chúng tôi</h5>
                <div className="flex gap-3">
                  <Button variant="icon" size="sm" className="bg-blue-600 hover:bg-blue-700 text-white">
                    <Facebook className="w-4 h-4" />
                  </Button>
                  <Button variant="icon" size="sm" className="bg-pink-600 hover:bg-pink-700 text-white">
                    <Instagram className="w-4 h-4" />
                  </Button>
                  <Button variant="icon" size="sm" className="bg-red-600 hover:bg-red-700 text-white">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-center gap-2 text-gray-300 hover:text-emerald-400 transition-colors">
                  ...
                  <Link to="/services" className="hover:text-emerald-400">Khám sức khỏe tổng quát</Link>
                </li>
                <li className="flex items-center gap-2 text-gray-300 hover:text-emerald-400 transition-colors">
                  <Scissors className="w-4 h-4" />
                  <Link to="/services" className="hover:text-emerald-400">Grooming & Spa</Link>
                </li>
                <li className="flex items-center gap-2 text-gray-300 hover:text-emerald-400 transition-colors">
                  <Shield className="w-4 h-4" />
                  <Link to="/services" className="hover:text-emerald-400">Tiêm phòng vaccine</Link>
                </li>
                <li className="flex items-center gap-2 text-gray-300 hover:text-emerald-400 transition-colors">
                  <Heart className="w-4 h-4" />
                  <Link to="/services" className="hover:text-emerald-400">Chăm sóc đặc biệt</Link>
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <div>
                    ...
                    <p>8:00 - 22:00 (T2-CN)<br />
                    <span className="text-emerald-400 font-medium">Cấp cứu 24/7</span></p>
                  </div>
                </li>
              </ul>
            </div>
